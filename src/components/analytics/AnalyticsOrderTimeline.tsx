...
function Item({ item, lastItem, ...other }: ItemProps): React.ReactElement {
  return (
    <TimelineItem {...other}>
      <TimelineSeparator>
        <TimelineDot
...
function AnalyticsOrderTimeline({ title, subheader, list, ...other }: Props): React.ReactElement {
  return (
    <Card {...other}>
...
AnalyticsOrderTimeline.defaultProps = {
  title: '',
  subheader: '',
};
