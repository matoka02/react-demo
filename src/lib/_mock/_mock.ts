...
export const mock_orderId = (index: number) => `ORD-${index}`;
...
export const mock_times = (index: number) =>
  // 'MM/DD/YYYY'
  [
    '11/08/2023',
    '04/09/2024',
...
export const mock_fullName = (index: number) =>
  [
    'Billy Stoltenberg',
    'Eloise Ebert',
    'Teresa Luettgen',
...
export const mock_mobile = (index: number) =>
  [
    '(499) 633-7585',
    '(922) 436-7361 x2235',
    '528-376-5760 x97546',
...
export const mock_email = (index: number) =>
  [
...
export const mock_price = (index: number) =>
  [
...
export const mock_company = (index: number) =>
  [
...
export const mock_location = (index: number) =>
  [
    'Murray, Utah, USA',
...
const mock_streetData = (index: number) => [
...
export const mock_address = () => {
  ...
  return `${mock_streetData(ra)} ${mock_location(rl)}`;
};

export const mock_boolean = (index: number) =>
  [
    true,
    false,
    true,
...
export const mock_postTitles = (index: number) =>
  [
...
export const mock_description = (index: number) =>
  [
...
export const mock_taskNames = (index: number) =>
  [
...
export const mock_productNames = (index: number) =>
  [
...
const mock_alphabet = 'abcdefghijklmnopqrstuvwxyz'.split('');

export const mock_promoCode = () => {
