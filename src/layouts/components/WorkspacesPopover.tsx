...
function WorkspacesPopover({
  ...
  sx,
  ...other
}: WorkspacesPopoverProps): React.ReactElement {
    ...
    <>
      <ButtonBase
        ...
        sx={{
          ...
          // bgcolor: (theme) => {
          //   const color = theme.vars?.palette?.grey?.['500Channel'];
          //   return color ? varAlpha(color, 0.08) : 'transparent';
          // },
          ...sx,
        }}
...
WorkspacesPopover.defaultProps = {
  data: {},
};
